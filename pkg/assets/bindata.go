...
func readmeMd() (*asset, error) {
	path := "/home/violet/art/arg/src/github.com/alimy/gin-music/assets/README.md"
	name := "README.md"
...
// albumsJson reads file data from disk. It returns an error on failure.
func albumsJson() (*asset, error) {
	path := "/home/violet/art/arg/src/github.com/alimy/gin-music/assets/albums.json"
	name := "albums.json"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
...
func configReadmeMd() (*asset, error) {
	path := "/home/violet/art/arg/src/github.com/alimy/gin-music/assets/config/README.md"
...
// configAppToml reads file data from disk. It returns an error on failure.
func configAppToml() (*asset, error) {
	path := "/home/violet/art/arg/src/github.com/alimy/gin-music/assets/config/app.toml"
